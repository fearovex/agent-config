...
- The `/commit` suggestion prohibition applies to ALL phases of `sdd-apply`, not only the final phase *(added: 2026-03-10)*
- No exception exists for changes that are "obviously correct" or "documentation-only" — the rule is unconditional *(added: 2026-03-10)*
- The next-step suggestion MUST use the exact form: `/sdd-verify <change-name>` *(added: 2026-03-10)*
