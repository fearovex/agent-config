...
**Check 2 — orchestrator-persona skill budget:**
1. IF `skills/orchestrator-persona/SKILL.md` exists: read and count characters
2. Budget: 8,000 chars
3. IF character count > 8,000:
   → Add INFO finding: `"orchestrator-persona skill is [N] chars ([N-8000] over 8,000 char budget). Consider trimming (ADR-041)."`
4. IF within budget:
   → Add INFO finding: `"orchestrator-persona budget OK: [N]/8,000 chars."`
...
**orchestrator-persona skill**: [N chars / 8,000 char budget — OK | OVER | not found — check skipped]
...
| **Budget Compliance**      | Informational only — no score deduction. Reports CLAUDE.md and orchestrator-persona skill character counts against ADR-041 governance budgets (20k global / 5k project / 8k skill). | N/A        |
